About pyutilib-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyutilib-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6008&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyutilib-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyutilib` can be installed with `conda`:
...
```
mamba install pyutilib
```

It is possible to list all of the versions of `pyutilib` available on your platform with `conda`:
...
```
mamba search pyutilib --channel conda-forge
```
...
mamba repoquery search pyutilib --channel conda-forge

# List packages depending on `pyutilib`:
mamba repoquery whoneeds pyutilib --channel conda-forge

# List dependencies of `pyutilib`:
mamba repoquery depends pyutilib --channel conda-forge
```
